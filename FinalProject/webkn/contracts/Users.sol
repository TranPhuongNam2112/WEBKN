...
contract Users {
    ...
    struct User {
        ...
        uint createdAt;
        uint updatedAt;
        uint NumberOfProjectsCreated;
        uint NumberOfProjectsSupported;
    }
    ...
    constructor() public
    {
        ...
        // Some dummy data
        addUser(address(0x333333333333), "Leo Brown", "12345","name@gmail.com","0992812801");
        addUser(address(0x111111111111), "John Doe", "abce1","john@gmail.com","0299129211");
        addUser(address(0x222222222222), "Mary Smith", "dlaoela","mary@gmail.com","012091200921");
    }
     ...
     */
    function registerUser(string memory _userName, string memory _passWord, string memory _email, string memory _phone) public
    returns(uint)
    {
    	return addUser(msg.sender, _userName,  _passWord, _email, _phone);
    }
     ...
     */
    function addUser(address _wAddr, string memory  _userName, string memory _passWord, string memory _email, string memory _phone) private
    returns(uint)
    {
     ...
     */
    function updateUser(string memory _newUserName, string memory _newEmail, string memory _newPhone) checkSenderIsRegistered public
    returns(uint)
    {
    ...
    returns(
    	...
    	return (
    		...
    		i.createdAt,
    		i.updatedAt,
    		i.NumberOfProjectsCreated,
    		i.NumberOfProjectsSupported
    	);
    }
